...
int main(void) {
  ...
  char* pinKorrekt = "1234";  /** Da die Pin geheim sein muss, habe ich sie diesmal vor dem compilieren geändert. Jetzt kann sie nicht mehr im Sourcecode nachgeschaut werden **/
